            ...
            if (this.isNonModelType(field)) {
                if (field.isList) {
                    return [
                        ...
                        (0, visitor_plugin_common_1.indent)(`.map((e) => ${this.getNativeType({ ...field, isList: false })}.fromJson(new Map<String, dynamic>.from(e)))`, 2),
                        (0, visitor_plugin_common_1.indent)(`.toList()`, 2),
                        (0, visitor_plugin_common_1.indent)(`: null`),
                    ]
                        .filter(e => e !== undefined)
                ...
                return [
                    `${fieldName} = json['${varName}'] != null`,
                    (0, visitor_plugin_common_1.indent)(`? ${this.getNativeType(field)}.fromJson(new Map<String, dynamic>.from(json['${varName}']))`),
                    (0, visitor_plugin_common_1.indent)(`: null`),
                ].join('\n');
            }
